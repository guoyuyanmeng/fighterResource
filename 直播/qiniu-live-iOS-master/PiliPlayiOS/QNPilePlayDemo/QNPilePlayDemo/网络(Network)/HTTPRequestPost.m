...
-(void)setconManagefiguration
{
    ...
    self.AFAppDotNetClient.requestSerializer = [AFHTTPRequestSerializer serializer] ;
...
//    [self.AFAppDotNetClient.requestSerializer setValue:@"application/json"forHTTPHeaderField:@"Accept"];
    ...
    [self.AFAppDotNetClient.requestSerializer setValue:@"application/x-www-form-urlencoded"forHTTPHeaderField:@"Content-Type"];
